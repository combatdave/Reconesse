    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(related_name=b'parentcategory', blank=True, to='past.Category', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(to='past.Article')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(related_name=b'category', to='past.Category'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='article',
            name='relatedArticles',
            field=models.ManyToManyField(related_name='relatedArticles_rel_+', to='past.Article'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='article',
